...
// Make sure window.SpecialPowers exists
(function( global ) {
  if ( !"SpecialPowers" in global ) {
    throw "Error: Missing SpecialPowers extension, see https://github.com/humphd/SpecialPowers";
  }
})(window);
...
// XXXhumph: already defined in SpecialPowers extension
