...
( function() {
  define( [ "core/logger", "core/eventmanager", "core/track", "core/popcorn-wrapper", "core/views/media-view" ], function( Logger, EventManager, Track, PopcornWrapper, MediaView ) {
    ...
    var Media = function( mediaOptions ) {
        ...
        var _tracks = [  ],
          ...
          _registry, _currentTime = 0,
          _duration = 0,
          _popcornOptions = mediaOptions.popcornOptions,
          _mediaUpdateInterval, _view, _popcornWrapper = new PopcornWrapper( _id, {
            popcornEvents: {
              muted: function() {
        ...
        this.addTrack = function( track ) {
          ...
          track._media = _this;
          _tracks.push( track );
          _em.repeat( track, [ "tracktargetchanged", "trackeventadded", "trackeventremoved", "trackeventupdated", "trackeventselected", "trackeventdeselected", "trackeventeditrequested" ] );
        ...
        this.removeTrack = function( track ) {
          ...
          if ( idx > -1 ) {
            ...
            _em.unrepeat( track, [ "tracktargetchanged", "trackeventadded", "trackeventremoved", "trackeventupdated", "trackeventselected", "trackeventdeselected", "trackeventeditrequested" ] );
