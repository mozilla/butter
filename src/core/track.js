...
define ( [ "./logger", "./eventmanager", "./trackevent", "./views/track-view" ], function(
Logger, EventManager, TrackEvent, TrackView ) {
  ...
  var Track = function( options ) {
      ...
      this.addTrackEvent = function( trackEvent ) {
        ...
        _em.repeat ( trackEvent, [ "trackeventupdated", "trackeventselected", "trackeventdeselected", "trackeventeditrequested" ] );
      ...
      this.removeTrackEvent = function( trackEvent ) {
        ...
        if ( idx > -1 ) {
          ...
          _em.unrepeat ( trackEvent, [ "trackeventupdated", "trackeventselected", "trackeventdeselected", "trackeventeditrequested" ] );
