...
define ( [ "./logger", "./eventmanager", "util/lang", "util/time", "./views/trackevent-view" ], function(
Logger, EventManager, LangUtil, TimeUtil, TrackEventView ) {
      ...
      this.update = function( updateOptions ) {
        ...
        if ( newStart >= newEnd ) {
          ...
          if ( _track && _track._media ) {
            ...
            if ( ( newStart > media.duration ) || ( newEnd > media.duration ) || ( newStart < 0 ) ) {
              failed = "invalidtime";
            }
          }
        }
