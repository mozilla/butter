...
define ( [ "core/logger", "core/eventmanager", "util/dragndrop" ], function(
Logger, EventManager, DragNDrop ) {
  ...
  return function( track ) {
    ...
    DragNDrop.droppable ( _element, {
      ...
      drop: function( dropped, mousePosition ) {
        ...
        var start, left, trackRect = _element.getBoundingClientRect ();
    ...
    this.addTrackEvent = function( trackEvent ) {
      ...
      _em.repeat ( trackEvent, [ "trackeventmousedown", "trackeventmouseover", "trackeventmouseout" ] );
    };
    this.removeTrackEvent = function( trackEvent ) {
      ...
      _em.unrepeat ( trackEvent, [ "trackeventmousedown", "trackeventmouseover", "trackeventmouseout" ] );
    };
  };
});
