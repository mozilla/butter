...
define( [ "core/logger", "core/eventmanager", "util/dragndrop" ], function( Logger, EventManager, DragNDrop ) {
  ...
  return function( trackEvent, type, inputOptions ) {
    ...
    var _id = "TrackEventView" + __guid++,
      ...
      _selected = false,
      _parent, _handles, _typeElement = document.createElement( "div" ),
      _draggable, _resizable, _this = this;
    ...
    _element.addEventListener( "mousedown", function( e ) {
      _eventManager.dispatch( "trackeventmousedown", {
        originalEvent: e,
        trackEvent: trackEvent
      });
    }, false );
    _element.addEventListener( "mouseup", function( e ) {
      _eventManager.dispatch( "trackeventmouseup", {
        originalEvent: e,
        trackEvent: trackEvent
      });
    }, false );
    _element.addEventListener( "mouseover", function( e ) {
      _eventManager.dispatch( "trackeventmouseover", {
        originalEvent: e,
        trackEvent: trackEvent
      });
    }, false );
    _element.addEventListener( "mouseout", function( e ) {
      _eventManager.dispatch( "trackeventmouseout", {
        originalEvent: e,
        trackEvent: trackEvent
      });
    }, false );
    ...
    _element.addEventListener( "dblclick", function( e ) {
      _eventManager.dispatch( "trackeventdoubleclicked", {
        originalEvent: e,
        trackEvent: trackEvent
      });
    }, false );
