...
define ( [ "core/comm", "core/eventmanager", "dialog/modal" ], function( Comm, EventManager, Modal ) {
  ...
  return function( dialogOptions ) {
    ...
    var _this = this,
      ...
      _comm, _window, _modalLayer, _statusInterval, _commQueue = [],
      _open = false,
      _features = [ "width=" + ( dialogOptions.width || DEFAULT_WINDOW_WIDTH ), "height=" + ( dialogOptions.height || DEFAULT_WINDOW_HEIGHT ), "toolbar=no", "menubar=no", "titlebar=yes", "location=no", "resizable=yes" ],
