...
define( [ "core/eventmanager", "./toggler", "./logo-spinner", "./context-button", "./header" ], function( EventManager, Toggler, LogoSpinner, ContextButton, Header ) {
  ...
  function Component( element, options ) {
    ...
    var _element = element,
      _onTransitionIn = options.transitionIn ||
    function() {}, _onTransitionInComplete = options.transitionInComplete ||
    function() {}, _onTransitionOut = options.transitionOut ||
    function() {}, _onTransitionOutComplete = options.transitionOutComplete ||
    function() {}, _validStates = options.states || [  ], _enabled = false;
  ...
  var __unwantedKeyPressElements = [ "TEXTAREA", "INPUT", "VIDEO", "AUDIO" ];
  ...
  function UI( butter, options ) {
    ...
    var processKey = {
      ...
      38: function( e ) { // up key
        var track, trackEvent, nextTrack;
        for ( var i = 0, seLength = butter.selectedEvents.length; i < seLength; i++ ) {
