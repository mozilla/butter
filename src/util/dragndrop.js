...
define ( [], function() {
  ...
  function Resizable ( element, options ) {
    var _leftHandle = document.createElement ( "div" ),
      ...
      _onStart = options.start ||
    function() {}, _onStop = options.stop ||
    function() {}, _updateInterval = -1, _scroll = options.scroll, _scrollRect, _elementRect;
  ...
  function Droppable ( element, options ) {
    ...
    var _hoverClass = options.hoverClass,
      _onDrop = options.drop ||
    function() {}, _onOver = options.over ||
    function() {}, _onOut = options.out ||
    function() {}, _mousePos, _zIndex, _draggedElement;
  ...
  function Draggable ( element, options ) {
    ...
    var _containment = options.containment,
      ...
      _mouseOffset, _mousePos, _elementRect, _scrollRect, _offsetParentRect, _containmentRect, _scrollAmount = options.scrollAmount || DEFAULT_SCROLL_AMOUNT,
      _oldZIndex, _updateInterval = -1,
      _onStart = options.start ||
    function() {}, _onStop = options.stop ||
    function() {
      return false;
    }, _originalPosition, _containmentPadding = __nullRect;
  ...
  function Sortable ( parentElement, options ) {
    ...
    var _onChange = options.change ||
    function() {}, _elements = [], _instance = {}, _mouseDownPosition, _draggingElement, _draggingOriginalPosition, _moved, _hoverElement, _placeHolder;
