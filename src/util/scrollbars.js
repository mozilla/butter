  ...
  function Vertical ( outerElement, innerElement ) {
    ...
    function setHandlePosition () {
      if ( innerElement.scrollHeight - _elementHeight > 0 ) {
        _handle.style.top = ( _elementHeight - _handleHeight ) * ( innerElement.scrollTop / ( innerElement.scrollHeight - _elementHeight ) ) + "px";
      } else {
  ...
  function Horizontal ( outerElement, innerElement ) {
    ...
    function setHandlePosition () {
      if ( _scrollWidth - _elementWidth > 0 ) {
        _handle.style.left = ( _elementWidth - _handleWidth ) * ( innerElement.scrollLeft / ( _scrollWidth - _elementWidth ) ) + "px";
      } else {
