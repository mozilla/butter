  ...
  Popcorn.plugin( "popup", {
    manifest: {
      about: {
        ...
        version: "0.1",
        author: "Kate Hudson @k88hudson, Matthew Schranz @mjschranz",
        website: "http://github.com/k88hudson, http://github.com/mjschranz"
      },
      options: {
        start: {
          elem: "input",
        ...
        type: {
          elem: "select",
          options: [ "Popup", "Speech", "Thought Bubble", "Fact", "Fiction" ],
          values: [ "popup", "speech", "thought", "fact", "fiction" ],
          label: "Type",
          "default": "thought"
        },
        triangle: {
    ...
    _setup: function( options ) {
      ...
      var target = document.getElementById( options.target ),
          ...
          context = this,
          audio,
          width = normalize( options.width, 1, 100 ) + "%",
      ...
      function _makeTriangle( innerDiv ) {
        ...
        function addDidYouKnow( style ) {
          ...
          innerDiv.className += " didyouknow";
        }


        //Set the base classes
        innerDiv.className =  "speechBubble " + options.type + " " + options.triangle + " " + options.classes + flip;
      ...
      if ( options.type === "popup" ) {
        ...
        container.classList.add( "popcorn-pop" );
        ...
        if ( options.sound ) {
          if ( !audio ) {
            audio = selectAudio( _pluginRoot + "sounds/mouthpop.ogg" );
            options.audio = audio;
          }
        }
      }
